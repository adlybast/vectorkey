                ...
                <div class="col-md-7">
                	<div class="box">
                        <div class="section-title">
                            <h2>Website <strong>Developer</strong></h2>
                            <hr>
                        ...
                        <ul>
                        	...
                        	<li>Good on commitment and highly responsible person</li>
                           	<li>Provicient with PHP, HTML, CSS, Javascript</li>
                           	<li>Familiar with PHP Framework</li>
                           	<li>Have a high level of creativity in design (web and graphic) </li>
                        </ul>  
                        <br>
						<h3><i class="fa fa-bell"></i> Responsibilities</h3>
						<hr>
						<ul>
							<li>Develop Web Based Application</li>
							<li>Develop Website with Content Management System</li>
						</ul>
                        <br>  
